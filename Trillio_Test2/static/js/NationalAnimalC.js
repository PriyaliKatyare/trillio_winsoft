/* globals Trillio_Test2 */

(function() {

  Trillio_Test2.NationalAnimalC = Trillo.inherits(Trillo.Controller, function(viewSpec) {
    Trillo.Controller.call(this, viewSpec);
  });

  var NationalAnimalC = Trillio_Test2.NationalAnimalC.prototype;
